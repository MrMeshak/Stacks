...
export default function EditStackForm(props: IStackFormProps) {
  ...
  return (
    <S.StackForm onSubmit={formik.handleSubmit}>
      ...
      <S.StackInputField id="name" name="name" value={formik.values.name} onChange={formik.handleChange} onBlur={formik.handleBlur} />
      <S.StackLabel htmlFor="color">Color</S.StackLabel>
      <S.StackInputFieldSelect id="color" name="color" value={formik.values.color} onChange={formik.handleChange} onBlur={formik.handleBlur}>
      ...
      <S.BtnContainer>
        ...
        <S.StackDeleteBtn type="button" onClick={handleDeletBtn}>
          Delete Stack
        </S.StackDeleteBtn>
      </S.BtnContainer>
    </S.StackForm>
