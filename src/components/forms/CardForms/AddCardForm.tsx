...
export default function CardForm(props: IAddCardFormProps) {
  ...
  return (
    <S.CardForm onSubmit={formik.handleSubmit}>
      <h2>Add Card</h2>
      <S.CardLabel htmlFor="title">Title</S.CardLabel>
      <br />
      <S.CardInputField id="title" name="title" value={formik.values.title} onChange={formik.handleChange} />
      <br />
      <S.CardLabel htmlFor="description">Description</S.CardLabel>
      <br />
      <S.CardInputFieldDescription id="description" name="description" value={formik.values.description} onChange={formik.handleChange} />
      <br />
      <S.CardLabel htmlFor="color">Color</S.CardLabel>
      <br />
      <S.CardInputFieldSelect id="color" name="color" value={formik.values.color} onChange={formik.handleChange}>
