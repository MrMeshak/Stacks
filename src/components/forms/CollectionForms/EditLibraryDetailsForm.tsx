...
export default function EditLibraryDetailsForm (props: IEditLibraryDetailsFormProps) {
  ...
  const handleDeleteBtn = ()=>{
    dispatch(deleteLibraryInCollection({
      collectionId: props.collectionId,
      libraryId: props.libraryId,
    }))
    if(props.libraryId === displayedLibraryId){
  ...
  return (
    <S.EditLibrayFormContainer onSubmit={formik.handleSubmit}>
      <S.EditLibraryLabel htmlFor='libraryName'>Library Name</S.EditLibraryLabel><br/>
      <S.EditLibraryInput id='libraryName' name='libraryName' onChange={formik.handleChange}/><br/>
      <S.BtnContainer>
        <S.SaveBtn type='submit'>Save</S.SaveBtn>
        <S.DeleteBtn type='button' onClick={handleDeleteBtn}>Delete Library</S.DeleteBtn>
      </S.BtnContainer>
