    ...
    <div>
      <S.StackContainer color={colorTheme.lightColor}>
        <S.StackTitleContainer>
          ...
          <div>
            <S.EditStackBtn color={colorTheme.darkColor} onClick={handleEditFormBtn}>
              <FontAwesomeIcon icon={faEdit} />
            </S.EditStackBtn>
            <S.AddCardBtn color={colorTheme.darkColor} onClick={handleCardFormBtn}>
              <FontAwesomeIcon icon={faPlus} />
            </S.AddCardBtn>
          </div>
        </S.StackTitleContainer>
        {props.stack.cards.map((card) => (
          <Card libraryId={props.libraryId} stackId={props.stack._id} card={card} key={card._id} />
        ))}
      </S.StackContainer>
